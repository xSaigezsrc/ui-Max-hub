...
function MIDN:Window(text)
	...
	EditBtn.MouseButton1Click:Connect(function()
		...
		Close2Icon.Position = UDim2.new(-0.0384615399, 0, 0.312910825, 0)
		Close2Icon.Size = UDim2.new(0, 25, 0, 25)
		Close2Icon.Image = "http://www.roblox.com/asset/?id=8652522964"
		Close2Icon.ImageColor3 = Color3.fromRGB(119, 122, 127)
...
local MIDN = MIDN:Window("Test")

local MIDNServer = MIDN:Server("xSaigez Hub",8652522964) --ใส่idรูปได้

local page1 = MIDNServer:Channel("Main")
local page2 = MIDNServer:Channel("Main")
...
page1:Button("Button",function(t)
    MIDN:Notification("Notification", "Max level!", "Okay!")
end)
